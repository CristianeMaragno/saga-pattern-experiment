...
public class MessagingConfiguration {
     ...
     */
    @Bean
    public DomainEventDispatcher approvalEventDispatcher(AprovacaoEventHandlers handlers,
                                                            DomainEventDispatcherFactory factory) {
        return factory.make("approvalEventDispatcher", handlers.domainEventHandlers());
    }
