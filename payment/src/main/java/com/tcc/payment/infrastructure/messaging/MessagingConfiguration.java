...
public class MessagingConfiguration {
     ...
     */
    @Bean
    public DomainEventDispatcher paymentEventDispatcher(PagamentoEventHandlers handlers,
                                                            DomainEventDispatcherFactory factory) {
        return factory.make("paymentEventDispatcher", handlers.domainEventHandlers());
    }
